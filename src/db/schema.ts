...
export const projects = pgTable('projects', {
  ...
  drawingIssuedDate: timestamp('drawing_issued_date'),
...
export const profitabilityData = pgTable('profitability_data', {
  ...
  materialsCost: doublePrecision('materials_cost'),
  purchasesCost: doublePrecision('purchases_cost'),
  estimatedLabourCost: doublePrecision('estimated_labour_cost'),
